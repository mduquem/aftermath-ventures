    ...
    <div className={classes.Servicios}>
      <Reveal>
        <div className={classes.Servicio}>
          ...
          <h2>
            Sabemos que todo emprendimiento empieza con recursos limitados. Es
            por esto que en <strong>Aftermath Ventures </strong> te ayudamos a
            crear soluciones desde cero.
          </h2>
      ...
      <Reveal>
        <div className={classes.Servicio}>
          ...
          <h2>
            ...
            Luego, debes recibir de tu cliente la{" "}
            <strong>valiosa retroalimentación </strong>que necesitas para la
            siguiente iteración de tu <strong>modelo de negocio.</strong>
          </h2>
          <div className={classes.Icono}>
            <img
              src={iconoTres}
